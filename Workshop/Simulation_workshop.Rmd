...
plot(dispRity::custom.subsets(data_darwin$traitspace, group = data_darwin$islandness),
     col = c("#E19A10", "#184695"))
plot(dispRity::custom.subsets(data_pigeon$traitspace, group = data_pigeon$islandness),
     col = c("#E19A10", "#184695"), legend = FALSE)
par(op)
```
